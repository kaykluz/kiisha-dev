import {
  baseKeys_default,
  getTag_default
} from "./chunk-MAFZKXMD.js";
import {
  package_default
} from "./chunk-ZVMGQ2VR.js";
import {
  selectSvgElement
} from "./chunk-7ZL2UAPP.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-6G3HAXOJ.js";
import {
  registerLayoutLoaders
} from "./chunk-5KZAJWY6.js";
import "./chunk-FPMQHVKQ.js";
import "./chunk-DG4YUZJY.js";
import "./chunk-GLHYGPEX.js";
import "./chunk-FZT33YMF.js";
import "./chunk-CNCWWUCJ.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-SCOKR7OX.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
// node_modules/streamdown/node_modules/lodash-es/isEmpty.js
...
// node_modules/streamdown/node_modules/mermaid/dist/mermaid.core.mjs
var id = "c4";
var detector = __name((txt) => {
  return /^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/.test(txt);
}, "detector");
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-YG6GDRKO-R6CXIX6X.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-NV44I4VS-4XMX4XPF.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-Q2GNP2WA-NYEYLXMM.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-NY62KEGX-ARGS6BTU.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-JELNMOA3-HWMXU3LS.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-WHAUD3N6-5CJBHXVY.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-ADFJNKIX-GUXHD5NJ.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-AYHSOK5B-2HGXZKSS.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-PRI3JC2R-2KHQHVKX.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-UZGBJVZJ-JL3RS6JC.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-WL72ISMW-WXKPZTVS.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-2ON5EDUG-QQFM7XJJ.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-WZHVMYZB-AW26ABSK.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-FKZM4ZOC-W2DPSEYH.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-4FDKWEC3-ZINB6V3E.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-XKPGCS4Q-4GFF6IE7.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-IT6M3QCI-RB5TUT23.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-VGOIOE7T-YJVNRP6E.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-3W4ZIXB7-72NB24FH.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-TZEHDZUN-RHLV4G7O.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-S2PKOQOG-45CYTCG7.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-QEK2KX5R-573VTK2A.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-VD42YOAC-7I5BR7A7.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-VXUJARFQ-QTWPSTVA.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-PSM6KHXK-3PFUE3FC.js");
...
//# sourceMappingURL=mermaid.core-WBJTRUGJ.js.map
